...
export const UI = {
  ...
  challengeTag:   { en: 'Next step', hi: 'अगला कदम' },
  challengeTitle: { en: 'Unlock the Mind Challenge', hi: 'माइंड चैलेंज अनलॉक कीजिए' },
  challengeBody:  { en: 'The full 16 PF personality test — 187 questions, scored personally by Babita, with a detailed report emailed to you.', hi: 'पूरा 16 PF पर्सनैलिटी टेस्ट — 187 सवाल, बबीता खुद स्कोर करती हैं, और विस्तृत रिपोर्ट आपके ईमेल पर आती है।' },
  challengeCta:   { en: 'Unlock for ₹300', hi: '₹300 में अनलॉक करें' },
