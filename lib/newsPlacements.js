...
export const NEWS_PLACEMENTS = [
  { value: 'top', label: 'Top of page (header ke upar)' },
  { value: 'after_hero', label: 'After hero image' },
]
...
export function placementLabel(value) {
  return (NEWS_PLACEMENTS.find(p => p.value === value) || NEWS_PLACEMENTS[1]).label
}
