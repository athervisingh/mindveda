...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      await loginWithGoogle(router.query.redirect || '/')
    } catch (err) {
  ...
  const features = [
    { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>, text: 'Private session history' },
    { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>, text: 'Saved packages & cart' },
    { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, text: 'Faster checkout flow' },
  ]
    ...
    <div className="min-h-screen flex flex-col bg-[#fbfaf7]">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="lg:hidden bg-[#1a3520] px-5 pt-6 pb-5">
          ...
          <h1 className="text-xl font-semibold text-white leading-snug">Welcome back to your<br />healing space.</h1>
          {/* Feature chips */}
        ...
        <div className="flex-1 flex items-stretch">
          ...
          <div className="hidden lg:flex lg:w-[48%] xl:w-[45%] flex-col bg-[#1a3520] p-10 xl:p-14">
            ...
            <p className="mt-4 text-white/70 leading-7 text-sm xl:text-base">
              Sign in to manage your packages, bookings, and wellness journey — all in one place.
            </p>
            ...
            <div className="mt-auto pt-8 relative h-52 xl:h-64 rounded-3xl overflow-hidden border border-white/10">
              <Image src="/hero.webp" alt="Mind Veda" fill className="object-cover object-top" />
          ...
          <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-8 lg:py-12 lg:px-12 xl:px-16">
            ...
            >
              ...
              <div className="bg-white rounded-3xl shadow-xl shadow-black/6 border border-gray-100 p-6 sm:p-8">
                ...
                {/* Header */}
                <div className="mb-6">
                  <p className="text-[#2d4f3a] text-xs uppercase tracking-[0.24em] font-semibold mb-2">Login</p>
                  <h2 className="text-2xl sm:text-3xl font-semibold text-[#1a3520]">Good to see you again</h2>
                  <p className="mt-1.5 text-gray-500 text-sm">Sign in to continue your session.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <Link href="/forgot-password" className="text-xs text-[#2d4f3a] hover:underline">Forgot password?</Link>
                    </div>
                    <div className="relative">
                      <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 rounded-2xl border border-gray-200 py-3 text-sm text-gray-600 hover:bg-gray-50 transition-colors font-medium disabled:opacity-50"
                >
                  {googleLoading ? (
                    <svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/></svg>
                  ) : (
                ...
                <p className="mt-5 text-center text-sm text-gray-500">
                  ...
                  <Link href="/signup" className="font-semibold text-[#2d4f3a] hover:underline">Sign up free</Link>
                </p>
              </div>
            </motion.div>
          </div>
